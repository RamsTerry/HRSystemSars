...
import za.gov.sars.hrsystem.common.DatasourceUtility;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"za.gov.sars.hrsystem.repo"}, transactionManagerRef = "transactionManager")
@ComponentScan(basePackages = {"za.gov.sars.hrsystem.service"})
...
public class TestDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("za.gov.sars.hrsystem.domain");
